<script lang="ts">
    ...
    let projects = [
        ...
        },
        {
            ...
            side: ["Difficulty: 💀", "Language: BrainF", "Status: Unfinished", "Type: Simple Printing", "Rating: Meh"],
